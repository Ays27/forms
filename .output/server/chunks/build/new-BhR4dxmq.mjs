import { defineComponent, ref, mergeProps, unref, useSlots, inject, computed, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createVNode, getCurrentInstance, isRef, toValue as toValue$1, resolveDynamicComponent, watch, toRef as toRef$1, camelize, Comment, cloneVNode, h, provide, useModel, createTextVNode, mergeModels, Fragment, reactive, toRefs, useSSRContext, readonly, customRef } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrRenderList, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual } from 'vue/server-renderer';
import { F as defu, x as hasProtocol } from '../_/nitro.mjs';
import { a as useAppConfig, b as appConfig, c as useRoute$1, d as useNuxtApp, p as pinia_prodExports } from './server.mjs';
import NuxtIcon from './index-4tvggdc7.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-ujjybxmB.mjs';
import { _ as __nuxt_component_0 } from './LogoutButton-C4zzSgmN.mjs';
import { u as useFormStore, P as Preview } from './Preview-Dik0YE4C.mjs';
...
_sfc_main$7.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/Icon.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/Chip.vue");
...
const _sfc_main$5 = /* @__PURE__ */ Object.assign({ inheritAttrs: false }, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(unref(props).chip ? _sfc_main$6 : unref(Primitive)), mergeProps({
        as: as.value.root
              ...
              _push2(ssrRenderComponent(unref(Slot), _ctx.$attrs, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    return [
                      renderSlot(_ctx.$slots, "default", {}, () => [
                        unref(props).icon ? (openBlock(), createBlock(_sfc_main$7, {
                          key: 0,
                          name: unref(props).icon,
                          "data-slot": "icon",
                          class: ui.value.icon({ class: unref(props).ui?.icon })
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/Avatar.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/LinkBase.vue");
            ...
            if (_push2) {
              ...
              return [
                __props.custom ? (openBlock(), createBlock(unref(Slot), { key: 0 }, {
                  ...
                  _: 2
                }, 1024)) : (openBlock(), createBlock(_sfc_main$4, mergeProps({ key: 1 }, {
                  ..._ctx.$attrs,
                  ...__props.exact && isExactActive ? { "aria-current": props.ariaCurrentValue } : {},
                  as: __props.as,
                  type: __props.type,
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/Link.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.8.1_@internation_e3059e92629dcb4d8d7982e9f6d0cb49/node_modules/@nuxt/ui/dist/runtime/components/Button.vue");
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "max-w-5xl mx-auto px-4 py-6 flex gap-6" }, _attrs))}><div class="flex-1 space-y-6"><div class="bg-white rounded-xl shadow-sm border-t-8 border-orange-600 p-6"><input${ssrRenderAttr("value", unref(formTitle))} class="w-full text-3xl outline-none mb-4"><input${ssrRenderAttr("value", unref(formDescription))} class="w-full text-gray-600 outline-none"></div><!--[-->`);
      ssrRenderList(unref(sections), (section) => {
        _push(`<div class="bg-white rounded-xl shadow-sm p-6 border-l-4 border-blue-500"><input${ssrRenderAttr("value", section.title)} class="text-2xl font-semibold outline-none mb-2"><p class="text-sm text-gray-500 mb-4"> Questions in this section: ${ssrInterpolate(unref(questions).filter(
          (q) => q.sectionId === section.id
        ).length)}</p><div class="space-y-4 mt-4"><!--[-->`);
        ssrRenderList(unref(questions).filter(
          (q) => q.sectionId === section.id
        ), (question) => {
      ...
      ssrRenderList(unref(questions), (question) => {
        ...
        if (question.type === "Multiple Choice") {
          ...
          ssrRenderList(question.options, (option, index) => {
            _push(`<div class="flex items-center gap-3"><input type="radio" disabled>`);
            if (option.imageUrl) {
              _push(`<div class="flex items-center gap-2"><img${ssrRenderAttr("src", option.imageUrl)} class="w-12 h-12 object-cover rounded border"><button class="text-xs text-blue-500"> Change </button><button class="text-xs text-red-500"> Remove </button></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(`<button class="text-gray-500 hover:text-orange-600">`);
            _push(ssrRenderComponent(unref(PhotoIcon), { class: "w-5 h-5" }, null, _parent));
            _push(`</button><input${ssrRenderAttr("value", option.text)} class="flex-1 border-b border-gray-200 outline-none"><button class="text-red-500"> ✕ </button></div>`);
          });
          _push(`<!--]--><button class="text-orange-600 text-sm"> + Add Option </button></div>`);
        } else if (question.type === "Checkboxes") {
          _push(`<div class="space-y-3"><!--[-->`);
          ssrRenderList(question.options, (option, index) => {
            _push(`<div class="flex items-center gap-3"><input type="checkbox" disabled>`);
            if (option.imageUrl) {
              _push(`<div class="flex items-center gap-2"><img${ssrRenderAttr("src", option.imageUrl)} class="w-12 h-12 object-cover rounded border"><button class="text-xs text-blue-500"> Change </button><button class="text-xs text-red-500"> Remove </button></div>`);
            } else {
              _push(`<!---->`);
          ...
          _push(`<div><select class="border rounded-lg px-3 py-2 w-full"><!--[-->`);
          ssrRenderList(question.options, (option, index) => {
            _push(`<option>${ssrInterpolate(option.text)}</option>`);
          });
          _push(`<!--]--></select><button class="text-orange-600 text-sm mt-3"> + Add Option </button></div>`);
        } else if (question.type === "Short Answer") {
          _push(`<div><input disabled placeholder="Short answer text" class="w-full border-b border-gray-300 py-2 outline-none"></div>`);
        } else if (question.type === "Paragraph") {
          _push(`<div><textarea disabled rows="4" placeholder="Long answer text" class="w-full border border-gray-300 rounded-lg p-3 outline-none"></textarea></div>`);
        } else {
          _push(`<!---->`);
        }
        if (question.type === "Short Answer" || question.type === "Paragraph") {
          _push(`<div class="mt-3"><label class="block text-sm text-gray-600 mb-1"> Character Limit </label><input${ssrRenderAttr("value", question.maxLength)} type="number" min="1" placeholder="No limit" class="border border-gray-300 rounded px-2 py-1 w-40"></div>`);
        } else if (question.type === "Linear Scale") {
          _push(`<div class="flex gap-6 mt-4"><!--[-->`);
          ssrRenderList(5, (n) => {
            _push(`<label><input type="radio" disabled> ${ssrInterpolate(n)}</label>`);
          });
          _push(`<!--]--></div>`);
        } else if (question.type === "Date") {
          _push(`<div><input type="date" disabled class="border rounded-lg px-3 py-2"></div>`);
        } else if (question.type === "Time") {
          _push(`<div><input type="time" disabled class="border rounded-lg px-3 py-2"></div>`);
        } else if (question.type === "Image") {
          _push(`<div class="space-y-4"><button class="flex items-center gap-2 text-orange-600">`);
          _push(ssrRenderComponent(unref(PhotoIcon), { class: "w-5 h-5" }, null, _parent));
          _push(` Add Image </button>`);
          if (question.imageUrl) {
            _push(`<img${ssrRenderAttr("src", question.imageUrl)} class="max-h-96 rounded-lg border">`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        if (question.imageUrl) {
          _push(`<div class="mb-4 space-y-2"><img${ssrRenderAttr("src", question.imageUrl)} class="max-h-64 rounded-lg border"><div class="flex gap-3"><button class="text-blue-500 text-sm"> Change Image </button><button class="text-red-500 text-sm"> Remove Image </button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (question.videoUrl) {
          _push(`<div class="mb-4 space-y-2"><iframe${ssrRenderAttr("src", getEmbedUrl(question.videoUrl))} class="w-full max-w-md h-56 rounded-lg border" allowfullscreen></iframe><div class="flex gap-3"><button class="text-blue-500 text-sm"> Change Video </button><button class="text-red-500 text-sm"> Remove Video </button></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (unref(selectedQuestionId) === question.id) {
          _push(`<div class="mt-6 pt-4 border-t flex gap-2"><button class="w-10 h-10 rounded hover:bg-gray-100 font-bold"> B </button><button class="w-10 h-10 rounded hover:bg-gray-100 italic"> I </button><button class="w-10 h-10 rounded hover:bg-gray-100 underline"> U </button><button class="w-10 h-10 rounded hover:bg-gray-100"> 🔗 </button><button class="w-10 h-10 rounded hover:bg-gray-100"> Tx </button></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<div class="mt-6 pt-4 border-t flex justify-between items-center"><select class="border rounded-lg px-3 py-2 text-sm"><option${ssrRenderAttr("value", void 0)}${ssrIncludeBooleanAttr(Array.isArray(question.goToSectionId) ? ssrLooseContain(question.goToSectionId, void 0) : ssrLooseEqual(question.goToSectionId, void 0)) ? " selected" : ""}> Continue Normally </option><!--[-->`);
        ssrRenderList(unref(sections), (section) => {
      ...
      _push(`<!--]--></div><div class="sticky top-24 h-fit bg-white rounded-xl shadow-sm p-2 flex flex-col gap-2"><button class="w-12 h-12 rounded-lg hover:bg-gray-100 flex items-center justify-center">`);
      ...
      _push(`</button><button class="w-12 h-12 rounded-lg hover:bg-gray-100"> 📂 </button></div>`);
...
const __nuxt_component_2 = Object.assign(_sfc_main$1, { __name: "Questions" });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LogoutButton = __nuxt_component_0;
      const _component_Questions = __nuxt_component_2;
      const _component_Preview = Preview;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen bg-[#F3F4F6]" }, _attrs))}><nav class="border-b bg-white px-6 py-3"><div class="flex items-center justify-between"><div class="flex items-center gap-4"><span class="font-medium text-gray-700">${ssrInterpolate(unref(formStore).formTitle)}</span></div><div class="flex items-center gap-2">`);
      ...
      if (!isPreviewMode.value) {
        _push(ssrRenderComponent(_component_Questions, {
...
//# sourceMappingURL=new-BhR4dxmq.mjs.map
