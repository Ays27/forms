import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import vue, { defineComponent, ref, shallowRef, watch, hasInjectionContext, inject, h, getCurrentInstance, nextTick, createElementBlock, provide, cloneVNode, isRef, computed, toValue, onServerPrefetch, reactive, defineAsyncComponent, Suspense, Fragment, createApp, shallowReactive, onErrorCaptured, unref, createVNode, resolveDynamicComponent, effectScope, toRef, mergeProps, getCurrentScope, isReadonly, toRaw, useSSRContext, isShallow, isReactive } from 'vue';
import { o as klona, q as defuFn, v as parseURL, j as encodePath, w as decodePath, x as hasProtocol, y as isScriptProtocol, n as joinURL, z as withQuery, A as sanitizeStatusCode, B as getContext, $ as $fetch$1, C as baseURL, D as hash, f as createError$1, E as executeAsync, F as defu } from '../_/nitro.mjs';
...
function requirePinia_prod() {
  ...
  (function(exports) {
    ...
    function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
      ...
      assign(vue$1.toRaw(store), setupStore);
...
const unhead_1s8A4iTcrTkGFfllf5cocCFKsuVzW5wiMwbHmHufalU = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./_id_-BINiu4Al.mjs')
  },
  {
    name: "forms-new",
    path: "/forms/new",
    component: () => import('./new-BhR4dxmq.mjs')
  },
  {
    name: "f-id",
    path: "/f/:id()",
    component: () => import('./_id_-BN2mlakW.mjs')
  },
  {
    name: "forms-id",
    path: "/forms/:id()",
    component: () => import('./_id_-CT7Ko1ei.mjs')
  },
  {
    name: "forms-slug",
    path: "/forms/:slug()",
    component: () => import('./_slug_-CGo9EjFL.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-BvKJvqgN.mjs')
  },
  {
    name: "preview",
    path: "/preview",
    component: () => import('./preview-BoYjVs2L.mjs')
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import('./signup-K99WTlxz.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-FfYDolEQ.mjs')
  }
];
var shared_cjs_prod = {};
...
const redirect_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
  const { session: session2, loading: loading2 } = useSession();
  if (loading2.value) return;
  const isLoggedIn = !!session2.value;
...
const revive_payload_server_yzgl96ydKFUsVPMowPDC68IjmWwYkdDIsK0pBkIU4KA = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./index-4tvggdc7.mjs').then((r) => r["default"] || r.default || r));
...
const plugins = [
  payloadPlugin,
  unhead_1s8A4iTcrTkGFfllf5cocCFKsuVzW5wiMwbHmHufalU,
  plugin$1,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BfNSGmqa.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D6Eu5RVW.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.4_@babel+core@7.29_50511366d20ae63ede64306d9cb00d5d/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.4.4_@babel+core@7.29_50511366d20ae63ede64306d9cb00d5d/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, _export_sfc as _, useAppConfig as a, appConfig as b, useRoute as c, useNuxtApp as d, entry_default as default, useSession as e, useRouter as f, encodeRoutePath as g, useRuntimeConfig as h, nuxtLinkDefaults as i, getIcon as j, useAsyncData as k, loadIcon as l, navigateTo as n, pinia_prodExports as p, resolveRouteObject as r, useHead as u };
